...
namespace HL_塾管理
{
    public partial class 課題一覧 : DockContent
    {
        ...
        /// 画面表示
        /// </summary>
        private void 課題一覧_Load(object sender, EventArgs e)
        {
        ...
        private void btn_課題追加_Click(object sender, EventArgs e)
        {
        ...
        private void btn_課題分配_Click(object sender, EventArgs e)
        {
            ...
            m_NewForm_課題分配.教師コード=
           m_NewForm_課題分配.教師コード = ((Form1)(this.Tag)).m_ユーザ登録.m_ログイン_教師コード;
